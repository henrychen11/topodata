...
const svg = __WEBPACK_IMPORTED_MODULE_0_d3__["h" /* select */](".map-container")
							.append("svg")
							.attr("height", height)
							.attr("width", width);
...
var tooltip = __WEBPACK_IMPORTED_MODULE_0_d3__["h" /* select */](".map-container").append("div")
                .attr("class", "tooltip")
                .style("opacity", 0);
...
__WEBPACK_IMPORTED_MODULE_0_d3__["f" /* json */]("data/us_states_map.json", function(error, us) {
	    ...
	    .enter()
	      ...
	      .attr("d", path)
				.on("mouseover", function(d, i){
					__WEBPACK_IMPORTED_MODULE_0_d3__["h" /* select */](this).style("fill", "yellow");
					console.log(tooltip);

					tooltip.transition().duration(250)
               .style("opacity", 1);
					__WEBPACK_IMPORTED_MODULE_0_d3__["h" /* select */](".average-salary").html("d3 selected element");
	          ...
	          .style("opacity", 0.75);
						__WEBPACK_IMPORTED_MODULE_0_d3__["h" /* select */](this).style("fill", "black");
	        	tooltip.transition().duration(250)
	               .style("opacity", 0);
				});
