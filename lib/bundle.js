...
const svg = __WEBPACK_IMPORTED_MODULE_0_d3__["k" /* select */](".map-container")
				.append("svg")
				.attr("height", height)
				.attr("width", width);
...
var tooltip = __WEBPACK_IMPORTED_MODULE_0_d3__["k" /* select */](".map-container").append("div")
                .attr("class", "tooltip")
				.style("opacity", 0);
	tooltip.append("div")
...
__WEBPACK_IMPORTED_MODULE_0_d3__["i" /* queue */]()
...
const colorScale = __WEBPACK_IMPORTED_MODULE_0_d3__["j" /* scaleThreshold */]()
...
const slider = __WEBPACK_IMPORTED_MODULE_0_d3__["k" /* select */](".slider")
					.on("input", function() {
						// console.log(this.value)
						__WEBPACK_IMPORTED_MODULE_0_d3__["k" /* select */](".year-label").html("Current Year: " + this.value)
	      ...
	      .attr("class", "states")
			...
			.enter()
				...
				.on("mouseover", function(d, i){
					__WEBPACK_IMPORTED_MODULE_0_d3__["k" /* select */](this).style("fill", "yellow").transition().duration(300).style("cursor", "pointer").style("display", "block")
					//Tooltip transitions
				...
				.on("mousemove", function(d, i){
					let xPos = __WEBPACK_IMPORTED_MODULE_0_d3__["h" /* mouse */](this)[0] - 15;
					let yPos = __WEBPACK_IMPORTED_MODULE_0_d3__["h" /* mouse */](this)[1] - 55;
				...
				.on("mouseout", function(d, i){
					__WEBPACK_IMPORTED_MODULE_0_d3__["k" /* select */](this)
						.transition()
						.duration(250)
...
const sideBar = __WEBPACK_IMPORTED_MODULE_0_d3__["k" /* select */]('.map-container')
.append('div')
.attr("class", "side-bar")
...
__WEBPACK_IMPORTED_MODULE_0_d3__["k" /* select */](".side-bar")
	.append("div")
...
__WEBPACK_IMPORTED_MODULE_0_d3__["k" /* select */](".footer")
	// .html('<p>asdfasdf</p>');
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "i", function() { return __WEBPACK_IMPORTED_MODULE_19_d3_queue__["a"]; });
