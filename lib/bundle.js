...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_2__src_map__["a"]; });
...
/* harmony default export */ __webpack_exports__["a"] = (function(url, callback) {
  var request,
      ...
      mimeType,
      headers = Object(__WEBPACK_IMPORTED_MODULE_0_d3_collection__["b" /* map */])(),
...
/* unused harmony default export */ var _unused_webpack_default_export = (function(nodes) {
  var simulation,
      ...
      alphaTarget = 0,
      velocityDecay = 0.6,
      forces = Object(__WEBPACK_IMPORTED_MODULE_1_d3_collection__["b" /* map */])(),
...
function ordinal(range) {
  var index = Object(__WEBPACK_IMPORTED_MODULE_0_d3_collection__["b" /* map */])(),
      domain = [],
      unknown = implicit;
  ...
  scale.domain = function(_) {
    ...
    domain = [], index = Object(__WEBPACK_IMPORTED_MODULE_0_d3_collection__["b" /* map */])();
...
__WEBPACK_IMPORTED_MODULE_0_d3__["a" /* csv */]("./data/state_wage_data2.csv", function(data){
...
var max = __WEBPACK_IMPORTED_MODULE_0_d3__["h" /* max */](__WEBPACK_IMPORTED_MODULE_0_d3__["c" /* entries */](averageSalarybyState), function(d) {
    return __WEBPACK_IMPORTED_MODULE_0_d3__["h" /* max */](__WEBPACK_IMPORTED_MODULE_0_d3__["c" /* entries */](d.value), function(e) {
        return __WEBPACK_IMPORTED_MODULE_0_d3__["h" /* max */](e.value);
    });
});
...
__WEBPACK_IMPORTED_MODULE_0_d3__["g" /* json */]("data/us_states_map.json", function(error, us) {
	    ...
	    .enter()
	      ...
	      .attr("d", path)
				.on("mouseover", function(d, i){
					__WEBPACK_IMPORTED_MODULE_0_d3__["j" /* select */](this).style("fill", "yellow");
					console.log(tooltip);

					tooltip.transition().duration(250)
               .style("opacity", 1);
					__WEBPACK_IMPORTED_MODULE_0_d3__["j" /* select */](".average-salary").html("d3 selected element");
					tooltip.select(".average-salary").html("lalalalallalala");
					//tooltip.style("display", "inline-block");
					tooltip.style("display", "inline");
				})
				.on("mousemove", function(d, i){
					let xPos = __WEBPACK_IMPORTED_MODULE_0_d3__["i" /* mouse */](this)[0] - 15;
					let yPos = __WEBPACK_IMPORTED_MODULE_0_d3__["i" /* mouse */](this)[1] - 55;
					// console.log("move", xPos, yPos);
					// tooltip.attr("transform", "translate(" + xPos + "," + yPos + ")");
					// tooltip.select("text").text("hello");
					return tooltip.style("top", (__WEBPACK_IMPORTED_MODULE_0_d3__["d" /* event */].pageY-10)+"px").style("left",(__WEBPACK_IMPORTED_MODULE_0_d3__["d" /* event */].pageX+10)+"px");
				})
	          ...
	          .style("opacity", 0.75);
						__WEBPACK_IMPORTED_MODULE_0_d3__["j" /* select */](this).style("fill", "black");
	        	tooltip.transition().duration(250)
	               .style("opacity", 0);
				});
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_5_d3_collection__["a"]; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "i", function() { return __WEBPACK_IMPORTED_MODULE_23_d3_selection__["d"]; });
...
/* unused harmony default export */ var _unused_webpack_default_export = (function(links) {
  ...
  function initialize() {
    ...
    var i,
        n = nodes.length,
        m = links.length,
        nodeById = Object(__WEBPACK_IMPORTED_MODULE_2_d3_collection__["b" /* map */])(nodes, id),
        link;
