	  ...
	  svg.append("path")
		  ...
		  .attr("d", path(__WEBPACK_IMPORTED_MODULE_1_topojson__["b" /* mesh */](us, us.objects.states, function(a, b) { return a !== b; })));
			...
			select.on("change", function() {
				updateStats(__WEBPACK_IMPORTED_MODULE_0_d3__["c" /* event */].target.value);
			});

			__WEBPACK_IMPORTED_MODULE_0_d3__["j" /* select */](".stats-container").append("div").attr("class", "state-label").text("Current State: ");
			__WEBPACK_IMPORTED_MODULE_0_d3__["j" /* select */](".stats-container").append("div").attr("class", "avg-salary").text("Average Salary: ");
			__WEBPACK_IMPORTED_MODULE_0_d3__["j" /* select */](".stats-container").append("div").attr("class", "med-salary").text("Median Salary: ");
			__WEBPACK_IMPORTED_MODULE_0_d3__["j" /* select */](".stats-container").append("div").attr("class", "tot-emp").text("Total Employee: ");
			updateStats("Alabama");
}
...
//Footer
__WEBPACK_IMPORTED_MODULE_0_d3__["j" /* select */](".map-container")
	.append("div")
	.attr("class", "footer");
