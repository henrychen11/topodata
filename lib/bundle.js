...
const projection =  __WEBPACK_IMPORTED_MODULE_0_d3__["d" /* geoAlbersUsa */]()
						.translate([width/2, height/2])
						.scale([1200]);

const path = __WEBPACK_IMPORTED_MODULE_0_d3__["e" /* geoPath */]()
				.projection(projection);

// //This is the main map element
const svg = __WEBPACK_IMPORTED_MODULE_0_d3__["l" /* select */](".map-container")
				.append("svg")
				.attr("height", height)
				.attr("width", width);
...
var tooltip = __WEBPACK_IMPORTED_MODULE_0_d3__["l" /* select */](".map-container").append("div")
                .attr("class", "tooltip")
				.style("opacity", 0);
	tooltip.append("div")
...
__WEBPACK_IMPORTED_MODULE_0_d3__["h" /* queue */]()
	.defer(__WEBPACK_IMPORTED_MODULE_0_d3__["f" /* json */], "data/us_states_map.json")
...
function ready(error, us, data) {
  if (error) throw error;
	      ...
	      .attr("class", "states")
			...
			.enter()
				...
				.on("mouseover", function(d, i){
					__WEBPACK_IMPORTED_MODULE_0_d3__["l" /* select */](this).style("fill", "yellow").transition().duration(300).style("cursor", "pointer").style("display", "block")
					//Tooltip transitions
				...
				.on("mousemove", function(d, i){
					let xPos = __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* mouse */](this)[0] - 15;
					let yPos = __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* mouse */](this)[1] - 55;
				...
				.on("mouseout", function(d, i){
					__WEBPACK_IMPORTED_MODULE_0_d3__["l" /* select */](this)
						.transition()
						.duration(250)
	  ...
	  svg.append("path")
		  ...
		  var color = __WEBPACK_IMPORTED_MODULE_0_d3__["i" /* scaleOrdinal */](__WEBPACK_IMPORTED_MODULE_0_d3__["k" /* schemeCategory20b */]);

		  var legendRectSize = 18;
		  var legendSpacing = 4;

		  const sideBar = __WEBPACK_IMPORTED_MODULE_0_d3__["l" /* select */]('.map-container')
							.append('div')
							.attr("class", "side-bar")
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_12__src_category20b__["a"]; });
