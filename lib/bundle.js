...
//Not used
const projection =  __WEBPACK_IMPORTED_MODULE_0_d3__["b" /* geoAlbersUsa */]()
...
const svg = __WEBPACK_IMPORTED_MODULE_0_d3__["f" /* select */]("svg");
							// .call(d3.zoom().on("zoom", function () {
						  //   svg.attr("transform", d3.event.transform);
						 	// 	}));

// //This is the tooltip element
const tooltip = __WEBPACK_IMPORTED_MODULE_0_d3__["f" /* select */]("map")
								.append("div")
...
__WEBPACK_IMPORTED_MODULE_0_d3__["d" /* json */]("data/us_states_map.json", function(error, us) {
	    ...
	    .enter().append("path")
	      .attr("d", path)
				...
				.on("mousemove", function(){
					let xPos = __WEBPACK_IMPORTED_MODULE_0_d3__["e" /* mouse */](this)[0] - 15;
					let yPos = __WEBPACK_IMPORTED_MODULE_0_d3__["e" /* mouse */](this)[1] - 55;
