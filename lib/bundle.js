...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_3__src_keys__["a"]; });
...
var colorScale = __WEBPACK_IMPORTED_MODULE_0_d3__["scale"].category10();
var x = __WEBPACK_IMPORTED_MODULE_0_d3__["scale"].linear()
		.domain(__WEBPACK_IMPORTED_MODULE_0_d3__["a" /* extent */](data, function(d){
			return d.age;
		}))
		.range([0,width]);
var y = __WEBPACK_IMPORTED_MODULE_0_d3__["scale"].linear()
		.domain([1,5])
		.range([height,0]);
var tickValues = [18,25,32,39,46,53,60,67,74];
var xAxis = __WEBPACK_IMPORTED_MODULE_0_d3__["svg"].axis()
			.scale(x)
			.tickValues(tickValues)
			.orient("bottom");
var xGridlines = __WEBPACK_IMPORTED_MODULE_0_d3__["svg"].axis()
			.scale(x)
			.tickValues(tickValues)
			.tickSize(-height,-height)
			.tickFormat("")
			.orient("bottom");
var yAxis = __WEBPACK_IMPORTED_MODULE_0_d3__["svg"].axis()
			.scale(y)
			.ticks(5)
			.tickSize(20)
			...
			.orient("left");
var yGridlines = __WEBPACK_IMPORTED_MODULE_0_d3__["svg"].axis()
				.scale(y)
				.tickSize(-width,0,0)
				.tickFormat("")
				.orient("left");
var responseScale = __WEBPACK_IMPORTED_MODULE_0_d3__["scale"].linear()
					.domain(__WEBPACK_IMPORTED_MODULE_0_d3__["a" /* extent */](data, function(d){
						return d.responses;
					}))
					.range([2,15]);
...
function plot(params){
	...
	var self = this;
	var donuts = __WEBPACK_IMPORTED_MODULE_0_d3__["b" /* keys */](params.data[0]).filter(function(d){
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_1_d3_array__["d"]; });
