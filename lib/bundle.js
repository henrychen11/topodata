  ...
  if (error) throw error;
	  ...
	  svg.append("path")
		  ...
		  .attr("d", path(__WEBPACK_IMPORTED_MODULE_1_topojson__["b" /* mesh */](us, us.objects.states, function(a, b) { return a !== b; })));
			...
			__WEBPACK_IMPORTED_MODULE_0_d3__["j" /* select */](".stats-container").append("div").attr("class", "med-salary");
			__WEBPACK_IMPORTED_MODULE_0_d3__["j" /* select */](".stats-container").append("div").attr("class", "tot-emp");
