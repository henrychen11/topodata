...
const svg = __WEBPACK_IMPORTED_MODULE_0_d3__["i" /* select */](".map-container")
				.append("svg")
				.attr("height", height)
				.attr("width", width);
...
var tooltip = __WEBPACK_IMPORTED_MODULE_0_d3__["i" /* select */](".map-container").append("div")
                .attr("class", "tooltip")
				.style("opacity", 0);
	tooltip.append("div")
	  ...
	  svg.append("g")
	    ...
	    .enter()
				...
				.on("mouseover", function(d, i){
					__WEBPACK_IMPORTED_MODULE_0_d3__["i" /* select */](this).style("fill", "yellow").transition().duration(350).style("cursor", "pointer")
	          ...
	          .style("opacity", 0.75);
						__WEBPACK_IMPORTED_MODULE_0_d3__["i" /* select */](this).style("fill", "black");
